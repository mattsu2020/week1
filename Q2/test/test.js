...
describe("Multiplier3 with PLONK", function () {
	...
	const test = argv[1].replace(/["[\]\s]/g, "")
	//console.log(test);
	//console.log("argv",argv);
        expect(await verifier.verifyProof(argv[0],new Array(test))).to.be.true;
    });
    it("Should return false for invalid proof", async function () {
        //[assignment] insert your script here
	let a = ""
	let b = 0
        expect(await verifier.verifyProof(Buffer.from(a),new Array(b))).to.be.false;
    });
});
